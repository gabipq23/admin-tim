          ...
          <div className="w-full flex items-center">
            ...
            >
              <SliderPrimitive.Track className="SliderTrack bg-zinc-200 relative grow rounded-full h-[5px]">
                <SliderPrimitive.Range className="SliderRange absolute bg-geekblue-500 rounded-full h-full" />
              </SliderPrimitive.Track>
              <SliderPrimitive.Thumb className="SliderThumb block w-[15px] h-[15px] bg-geekblue-500 rounded-full shadow-[0_0_0_5px_rgba(0,0,0,.12)] focus:outline-none focus:shadow-[0_0_0_5px_rgba(0,0,0,.12),0_0_2px_2px_rgba(0,0,0,.3)]" />
            </SliderPrimitive.Root>
          </div>
        </div>
