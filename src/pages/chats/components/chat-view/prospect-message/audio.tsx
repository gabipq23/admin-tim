      ...
      <div className="w-[25%]">
          ...
          <div className="w-full flex items-center">
            ...
            >
              <SliderPrimitive.Track className="SliderTrack bg-zinc-200 relative grow rounded-full h-[5px] cursor-pointer">
                <SliderPrimitive.Range className="SliderRange absolute bg-geekblue-500 rounded-full h-full cursor-pointer" />
              </SliderPrimitive.Track>
              <SliderPrimitive.Thumb className="SliderThumb cursor-pointer block w-[15px] h-[15px] bg-geekblue-500 rounded-full shadow-[0_0_0_5px_rgba(0,0,0,.12)] focus:outline-none focus:shadow-[0_0_0_5px_rgba(0,0,0,.12),0_0_2px_2px_rgba(0,0,0,.3)]" />
            </SliderPrimitive.Root>
            ...
            {isPlaying ? (
              <Button
                ...
                onClick={pause}
              >
                <Pause size={20} className="text-geekblue-500" />
              </Button>
            ) : (
              <Button
                variant="ghost"
                ...
                onClick={play}
              >
                <Play size={20} className="text-geekblue-500" />
              </Button>
        ...
        <div className="justify-between items-center flex w-full">
          <div className="flex items-center gap-1 pt-1">
            <Clock size={16} className="text-geekblue-500" />
